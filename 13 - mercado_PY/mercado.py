...
def menu() -> None:
    ...
    print('Selecione uma opçaõ abaixo:')
...
def comprar_produto() -> None:
    if len(produtos) > 0:
        print('Informe o código do produto quee deseja adicionar ao carrinho: ')
        print('---------------------------------------------------------------')
        print('==================== Produtoss Disponíveis ====================')
        for produto in produtos:
            print(produto)
            print('---------------------------------------------------------------')
            sleep(1)
